...
#define BARNACLETIMESTAMP           (0x‭5ABAAB69‬)
...
extern BARNACLE_IDENTITY_PRIVATE CompoundIdTA;
extern BARNACLE_CERTSTORE CertStoreTA;
extern const BARNACLE_AGENT_HDR AgentHdrTA;
